...
> owner/repo: `metrics-odr/dash-dany-E16` · URL do Pages:
> `https://metrics-odr.github.io/dash-dany-E16/`. O **token
...
URL pública após publicar: `https://metrics-odr.github.io/dash-dany-E16/`
...
- Repository access: **Only select repositories → `dash-dany-E16`**
...
### URL
```
https://api.github.com/repos/metrics-odr/dash-dany-E16/actions/workflows/deploy.yml/dispatches
```
### Método
```
POST
